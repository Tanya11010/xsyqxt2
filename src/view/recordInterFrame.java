...
public class recordInterFrame extends JInternalFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    recordInterFrame frame = new recordInterFrame();
     ...
     * Create the frame.
     */
    public recordInterFrame() {
        setFrameIcon(new ImageIcon(recordInterFrame.class.getResource("/images/modify.png")));
        setMaximizable(true);
        setIconifiable(true);
        setClosable(true);
        ...
        button2.setIcon(new ImageIcon(recordInterFrame.class.getResource("/images/modify.png")));
        ...
        button3.setIcon(new ImageIcon(recordInterFrame.class.getResource("/images/delete.png")));
        ...
        button1.setIcon(new ImageIcon(recordInterFrame.class.getResource("/images/search.png")));
