...
public class addInterFrame extends JInternalFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    addInterFrame frame = new addInterFrame();
     ...
     * Create the frame.
     */
    public addInterFrame() {
        setFrameIcon(new ImageIcon(addInterFrame.class.getResource("/images/edit.png")));
        setClosable(true);
        setIconifiable(true);
//        setTitle("填报信息");
        ...
        button2.setIcon(new ImageIcon(addInterFrame.class.getResource("/images/reset.png")));
