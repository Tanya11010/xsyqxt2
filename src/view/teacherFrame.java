...
public class teacherFrame extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    studetFrame frame = new studetFrame();
     ...
     */
    public teacherFrame() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(teacherFrame.class.getResource("/images/teacher2.gif")));
        setTitle("教师界面");
        ...
        menuItem1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                addInterFrame addinterframe=new addInterFrame();
                addinterframe.setVisible(true);
                table3.add(addinterframe);
            }
        });
        menuItem1.setIcon(new ImageIcon(teacherFrame.class.getResource("/images/add.png")));
        menuBar.add(menuItem1);
        
        JMenuItem menuItem2 = new JMenuItem("修改密码");
        menuItem2.setIcon(new ImageIcon(teacherFrame.class.getResource("/images/password.png")));
        menuBar.add(menuItem2);
        
        JMenuItem menuItem4 = new JMenuItem("联系我们");
        menuItem4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                InterFrame4  interframe4=new InterFrame4();
